...
st.markdown("<h1 style='text-align: center; color: pink;'>Info Retrieval from Website Panda 🦜</h1>", unsafe_allow_html=True)
st.markdown("<h3 style='text-align: center; color: green;'>Developed by <a href='https://github.com/babaji562002'>@BOyanmol for panda ❤️</a></h3>", unsafe_allow_html=True)
